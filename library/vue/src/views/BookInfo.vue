...
export default {
  ...
  methods: {
    getBook(id) {
      this.$http
        .get(`${this.$store.state.origin}/book/getBookDetail`,{params:{isbn:this.$route.params.isbn}})
        .then(
          res => {
            res.json().then(body => {
              if (body != null) {
    ...
    borrowBook() {
      this.$http
        .get(`${this.$store.state.origin}/book/borrowBook`,{params:{isbn:this.$route.params.isbn}})
        .then(
          res => {
            res.json().then(body => {
              if (body != null) {
